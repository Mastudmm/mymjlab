...
def make_velocity_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  # AMP integration note:
  # - Do NOT add a separate "amp" observation term in this env cfg.
  #   AMP discriminator observations are produced by RslRlVecEnvWrapper.get_amp_obs_for_expert_trans().
  # - Do NOT add a separate "amp_reward" term here.
  #   AMP reward is computed in AmpOnPolicyRunner via discriminator.predict_amp_reward(),
  #   then blended with task reward by amp_task_reward_lerp.
