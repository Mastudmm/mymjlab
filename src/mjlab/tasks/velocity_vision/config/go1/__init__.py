...
from mjlab.tasks.velocity_vision.rl import VelocityOnPolicyRunner
...
register_mjlab_task(
  task_id="Mjlab-VelocityVision-Rough-Unitree-Go1",
...
register_mjlab_task(
  task_id="Mjlab-VelocityVision-Flat-Unitree-Go1",
